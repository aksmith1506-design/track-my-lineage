...
export default async function PersonPage({ params }) {
  ...
  const isLiving =
  !person.deathYear && new Date().getFullYear() - person.birthYear < 120;
...
if (isLiving) {
  return (
    <main style={{ maxWidth: "800px", margin: "auto", padding: "40px" }}>
      ...
      <h1 style={{ marginTop: "20px" }}>Private Profile</h1>

      <p>
        This individual may still be living, so their personal information
        is not displayed for privacy reasons.
      </p>
    </main>
  );
}
